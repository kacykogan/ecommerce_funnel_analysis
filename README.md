...
•	Key Fields Used:
o	user_pseudo_id – unique user identifier
o	event_name – GA4 events (view_item, add_to_cart, begin_checkout, purchase)
...
o	Cleaned traffic source labels for clarity (e.g., (direct)/(none) → Direct, <Other>/organic → Organic Search (Other))
2.	Funnel Construction
o	Defined a strict, ordered funnel from View Item → Purchase
